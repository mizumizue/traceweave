 ...
 * - 関連文書: TC-0059, REQ-0030, SPEC-0025, SPEC-0020
 */
test('TC-0059: subject 表示フォーマット - ヘッダー接尾辞とブラウザタイトルが契約どおりであること', () => {
 ...
 * - 関連文書: TC-0058, REQ-0030, SPEC-0025
 */
test('TC-0058: buildTraceWeaveReport - subject がレポートとマークダウン出力に反映されること', () => {
 ...
 * - 関連文書: TC-0058, REQ-0030, SPEC-0025
 */
test('TC-0058: buildTraceWeaveReport - subjectOverride が自動解決より優先されること', () => {
