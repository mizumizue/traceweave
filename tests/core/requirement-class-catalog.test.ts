 ...
 * - 関連文書: TC-ITa-0002-01, REQ-0026, REQ-0027, SPEC-0021
 */
test('TC-ITa-0002-01: 要件区分 - カタログ伝播・フィルターおよびグループ分割が混入なく動作すること', () => {
  const nodes: DocNode[] = [
 ...
 * - 関連文書: TC-ITa-0002-02, NEED-0009, REQ-0026, REQ-0027, REQ-0028
 */
test('TC-ITa-0002-02: 要件区分 - 実レポートの FR/NFR 件数と NEED-0009 トレーサビリティが整合すること', () => {
