 ...
 * - 関連文書: TC-UT-0005, REQ-0014, SPEC-0014
 */
test('TC-UT-0005: VisualTestPyramid - 5大工程のテスト件数から全体構成比率および階層幅比率が正確に計算されること', () => {
 ...
 * - 関連文書: TC-UT-0005, REQ-0014, SPEC-0014
 */
test('TC-UT-0005: VisualTestPyramid - ピラミッド層クリック時に対象工程識別子がコールバックへ渡されること', () => {
