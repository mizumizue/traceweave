 ...
 * - 関連文書: TC-0062, REQ-0032
 */
test('TC-0062: UseCaseSufficiencyScorer - requirement_refs のロールアップと未割当判定が正しいこと', () => {
 ...
 * - 関連文書: TC-0062, SPEC-0027
 */
test('TC-0062: buildTraceWeaveReport - ユースケース充足度がレポート JSON に含まれること', () => {
