 ...
 * - 関連文書: TC-ITb-0013-01, REQ-0017, REQ-0018, REQ-0019, SPEC-0017
 */
test('TC-ITb-0013-01: DecisionsCatalogBuilder - 全9種別のドキュメント集約、相互参照解決（ACT-UC逆引き・DSN-ADR双方向）およびフィルタリングが正しく機能すること', () => {
  const nodes: DocNode[] = [
    {
      id: 'ACT-0001',
      kind: 'actor',
 ...
 * - 関連文書: TC-ITb-0013-02, REQ-0017, REQ-0018
 */
test('TC-ITb-0013-02: DecisionsCatalogBuilder - 実際のdocsディレクトリを読み込み、全種別のカタログ集約と相互参照解決が決定論的に成功すること', () => {
