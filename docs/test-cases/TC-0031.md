...
depends_on: []
tags: [test, integration, catalog, decisions, relationships, cli]
links: []
---
## Content
...
### Actual Results
- 主要種別の集約、双方向リンク解決、フィルタリング、および CLI JSON 出力のアサーションが成功した。

### Evidence
`tests/core/decisions-catalog-integration.test.ts` の実行結果ログ。
