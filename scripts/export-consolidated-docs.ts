...
function buildDocumentIndex(): string {
  ...
  lines.push(
    ...
    '| 領域 | 代表 TC |',
    '|---|---|',
    '| グラフ・パーサー | TC-0001, TC-0004 |',
    '| CLI・CI | TC-0005, TC-0007, TC-0033 |',
    '| 対話型テスト | TC-0008, TC-0009 |',
    '| UI 操作 | TC-0015, TC-0021, TC-0024, TC-0029 |',
    '| グラフ表示 | TC-0032 |',
    '| URL/履歴 | TC-0019, TC-0020 |',
    '| 要件区分 | TC-0034, TC-0035, TC-0036 |',
    '| トースト | TC-0037 |',
    '',
    '---',
    '',
